...
file = '/home/lennartgolks/PycharmProjects/testSNRandRes/'
...
file = '/home/lennartgolks/PycharmProjects/testSNRandRes/SNR45/pointAcc0.00034285714285714285/'
...
#     ax3.plot(TempResults[0, :], height_values, label='true T', color = TrueCol, marker ='o', zorder =1, markersize=10)
#
#     for r in range(1, SampleRounds):
#         Sol = TempResults[r, :]
#         ax3.plot(Sol, height_values, marker='+', color=ResCol, zorder=0, linewidth=0.5,
